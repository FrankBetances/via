// ============================================================================
// VENDORIZADO de FrankBetances/Valeria · src/ValeriaCatPixel.tsx
//
//   commit de origen: 0715146 (2026-08-10)
//   sha256 del fichero original: 02ff5a2643453680f414ef69c356ab8d1c212c7e2d3b94a606b459bace3bac7f
//
// NO EDITAR AQUÍ. Lúa es de los dos productos y su fuente es el repositorio de
// Valeria+; un arreglo hecho en esta copia se pierde en la siguiente
// sincronización y, peor, separa la cara de la app de la del aparato. Para
// cambiar el dibujo se cambia allí y se vuelve a copiar:
//
//   cp ../Valeria/src/ValeriaCatPixel.tsx src/Lua/vendor/ValeriaCatPixel.tsx
//   node scripts/check-lua-brand.js --update   # reescribe cabecera y manifiesto
//
// Se conserva el nombre original del fichero, con su cuerpo intacto, para que el
// diff contra Valeria+ sea exactamente esta cabecera y nada más.
//
// El original sigue a partir de aquí.
// ============================================================================
// ============================================================================
