...
export const useCreateProsodyAnalysisMutation = createLocalMutation<ProsodyAnalysis, ProsodyAnalysis>(
  async (item: ProsodyAnalysis) => ProsodyAnalysisRepository.createProsodyAnalysis(item),
);
